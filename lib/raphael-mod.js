...
(function () {
    ...
    if (R.svg) {
        ...
        var theGroup = function(svg) {
        	...
        	res.add = function(new_el) {
                this.members.push(new_el);
                svg.canvas.removeChild(new_el.node);
                el.appendChild(new_el.node);        	
        	};
        	
        	res.translate = function (dx, dy) {
                for (var i = this.members.length; i--; ) {
                	this.members[i].translate(dx, dy);
                }
        	};

        	res.rotate = function (degree, x, y) {
        		console.log("group.rotate: not implemented yet");
        	};

        	res.scale = function (x, y) {
        		console.log("group.scale: not implemented yet");
        	};
